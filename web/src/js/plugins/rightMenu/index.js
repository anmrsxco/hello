...
class RightM {
  ...
  bindEvent() {
    ...
    this.rightMask.addEventListener('click', this.newHdClick);
    this.rightMask.addEventListener('keyup', this.newHdKeyup);
  }
  renderList(html) {
  ...
  close(all) {
    ...
    this.rightMask.removeEventListener('click', this.newHdClick);
    this.rightMask.removeEventListener('keyup', this.newHdKeyup);
