...
class Validate {
  ...
  // 绑定事件
  bindEvents() {
    this._hdDown = this.hdDown.bind(this);
    this._hdClick = this.hdClick.bind(this);
    this.slider.addEventListener('mousedown', this._hdDown);
    this.slider.addEventListener('touchstart', this._hdDown);
    this.validateMask.addEventListener('click', this._hdClick);
  }
  close() {
    this.slider.removeEventListener('mousedown', this._hdDown);
    this.slider.removeEventListener('touchstart', this._hdDown);
    this.validateMask.removeEventListener('click', this._hdClick);
